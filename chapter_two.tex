...
Spytał on Szóstego Patriarchy o znaczenie nauk o czterech pojazdach Dharmy\footnote{四乘法 sì chéng fǎ}.
Chociaż Budda nauczał jedynie o trzech pojazdach, Huineng mówił również o Najwyższym Pojeździe%
\footnote{最上乘 zuì shàng chéng}.
...
\footnote{小乘 xiǎo chéng śrawakajana};
przebudzenie się na Dharmę i zrozumienie jej zasad --- Średnim Pojazdem%
\footnote{中乘 zhōng chéng pratyekabuddhayana};
...
W sekcjach 45. i 46. \textit{Sutry platformy} przekazano nauki dotyczące buddyjskiej teorii poznania: o trzech kategoriach Dharmy (三科法門 \pinyin{sān kē fǎmén}) i trzydziestu sześciu konfrontacjach aktywności (動三十六對 \pinyin{dòng sān shí liù duì}).
...
Ponieważ przeciwieństwa wynikają z siebie nawzajem, ostatecznie nie będzie już miejsca na takie kategorie myślowe i możliwe będzie wyjście poza dualizm
(Huineng i Yampolsky 2012: 170-172).

Pięć nagromadzeń\footnote{skandha 五蘊 wǔ yùn --- forma materialna, uczucia, percepcja, formacje mentalne, świadomość}
Osiemnaście sfer zmysłowych\footnote{dhatu 十八界}
Dwanaście wejść\footnote{ayatana 十二入}
