...
Kanoniczna biografia Pierwszego Patriarchy oparta jest na przedmowie do przypisywanego mu \textit{Erru sixing} (二入四行 \pinyin{Èrrù sìxíng}, `Traktat o dwóch wejściach i czterech praktykach').
...
Bodhidharma miał otrzymać przekaz Dharmy, pochodzący w nieprzerwanej linii od samego historycznego Buddy Siakjamuniego, Siddharta Gautamy. Z powodu bariery językowej nazywano go ,,błękitnookim barbarzyńcą'' (碧眼胡 \pinyin{bìyǎnhú}).
(Buswell 2004: 57).
%
