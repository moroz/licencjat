...
\textit{Sutra platformy\index{Sutra platformy 壇經} Szóstego Patriarchy} (chiń. 六祖壇經, Pinyin: \pinyin{Liùzǔ Tánjīng}) jest apokryficznym tekstem buddyzmu Chan\index{Chan} (patrz: sekcja \textit{Przedstawienie buddyzmu Chan}), przypisywanym legendarnemu Szóstemu Patriarsze Chan, Dajian Huinengowi\index{Dajian Huineng 大鑒惠能} (chiń. 大鑒惠能, Pinyin: \nazwisko{Dàjiàn Huìnéng}). Najstarsza zachowana wersja tego dzieła powstała w VIII w. w Chinach.

Celem niniejszej pracy jest przedstawienie historycznego tła powstania \textit{Sutry Platformy\index{Sutra platformy 壇經}}, analiza jej treści oraz opisanie wpływu, jaki wywarła na buddyzm chiński.

W pierwszym rozdziale pracy omówiona jest hagiografia Huinenga\index{Dajian Huineng 大鑒惠能}, głównej postaci sutry.
Rozdział drugi stanowi analiza treści \textit{Sutry platformy\index{Sutra platformy 壇經}}, trzeci natomiast poświęcony jest dalszemu rozwojowi szkoły Chan\index{Chan}.
...
Odwołania do tekstu \textit{Sutry Platformy\index{Sutra platformy 壇經}} w niniejszej pracy odnoszą się do jej przekładu pt. \textit{The Platform Sutra of the Sixth Patriarch: The Text of the Tun-huang Manuscript} Philipa B. Yampolsky'ego, wydanego drukiem przez Columbia University Press w roku 1967 i wznowionego w roku 2012.
...
\section{Przedstawienie buddyzmu Chan\index{Chan}}
Buddyzm Chan (禪宗 \pinyin{Chán zōng}) jest, obok Szkoły Czystej Krainy\index{Szkoła Czystej Krainy, amidyzm}%
...
Tradycyjne chińskie zapisy dotyczące historii tradycji Chan\index{Chan} przedstawiają ją jako nieprzerwaną linię przekazu nauk i doświadczenia z patriarchy (祖師 \pinyin{zǔshī}) na patriarchę, sięgającą aż do historycznego Buddy.
...
Pierwsze wzmianki o linii przekazu patriarchów Chan pojawiają się na steli pogrzebowej poświęconej mnichowi Faru\index{Faru 法如} (法如 \nazwisko{Fǎrú}), który miał być uczniem Piątego Patriarchy, Daman Hongrena\index{Daman Hongren 大滿弘忍} (大滿弘忍 \nazwisko{Dàmǎn Hóngrěn}).
Według tego zapisu linia przekazu Chan prowadziła od Bodhidharmy\index{Bodhidharma} (菩提達摩 Pútídámó, od skt. \textit{bodhi} `oświecenie' i \textit{dharma} `zjawiska; nauki Buddy'), poprzez Dazu Huike\index{Dazu Huike 大祖慧可}  (大祖慧可 \nazwisko{Dàzǔ Huìkě}), Jianzhi Sengcana\index{Jianzhi Sengcan 鑑智僧璨} (鑑智僧璨 \nazwisko{Jiànzhì Sēngcàn}), Dayi Daoxina\index{Dayi Daoxin 大醫道信} (大醫道信 \nazwisko{Dàyī Dàoxìn}) i Hongrena, do Faru
(Huineng\index{Dajian Huineng 大鑒惠能}, Schlütter i Teiser 2012: 53-54, 56).

Za założyciela buddyzmu Chan\index{Chan} uznaje się przybyłego z Indii mistrza Bodhidharmę\index{Bodhidharma}.
Pierwsza wzmianka o nim pojawia się w tekście pt. ``Zapisy o klasztorach w Luoyangu\index{Luoyang 洛陽}'' (洛陽伽藍記 \pinyin{Luòyáng qiélán jì}) autorstwa Yang Xuanzhi (楊衒之), pochodzącym z ok. 547 roku.
...
Przybywszy do Luoyangu, Pierwszy Patriarcha miał się zachwycać pięknem tamtejszych świątyń, a zwłaszcza jednej, zwanej Yongning Si\index{Yongning Si 永寧寺} (永寧寺 \pinyin{Yǒngníng Sì}).
...
Została ona napisana przez uczonego imieniem Tanlin\index{Tanlin 曇林} (曇林 \nazwisko{Tánlín}), specjalistę od tekstu zwanego ``Sutrą Ryku Lwa Królowej Śrimala'' (skt. \textit{Śrīmālādevī Si\d{m}hanāda Sūtra}, chiń. 勝鬘師子吼一乘大方便方廣經 \pinyin{Shèng mán shīzi hǒu yī chéng dà fāngbiàn fāng guǎng jīng}).
Tradycyjnie uważano go za ucznia Bodhidharmy\index{Bodhidharma}, jednak bardziej prawdopodobne jest, że jego nauczycielem był Dazu Huike\index{Dazu Huike 大祖慧可}, uczeń Pierwszego Patriarchy.
...
W ``Kontynuowanych biografiach wybitnych mnichów\index{Kontynuowane biografie wybitnych mnichów 續高僧傳}'' zawarta jest również historia życia praktykującego imieniem Sengfu (僧副).
...
Spotkał on swego nauczyciela w jaskini, w której ten mieszkał, a otrzymawszy od niego pouczenia na temat ,,zasad medytacji\index{medytacja}'' (定學宗 \pinyin{dìngxué zōng}), przyjął ślubowania mnisie. Pomiędzy rokiem 494 a 497 udał się do miasta Jiankang\footnote{Jiankang (建康 \toponim{Jiànkāng}), w różnych okresach znane również pod nazwami Jianye (建鄴 \toponim{Jiànyè}) oraz Jinling (金陵 \toponim{Jīnlíng}) --- miasto w delcie rzeki Yangzi, stolica sześciu różnych dynastii, m.in. czterech Południowych Dynastii. Ruiny Jiankangu znajdują się w granicach administracyjnych Nankinu (南京 \toponim{Nánjīng}) w prowincji Jiangsu.}, wówczas stolicy południowych Chin, i osiedlił w świątyni Dinglin Xia Si (定林下寺 \pinyin{Dìnglín xià sì}) w bezpośrednim sąsiedztwie miasta.
Jeżeli przyjąć, że mistrz Dharma był w istocie Bodhidharmą\index{Bodhidharma}, tak jak czynią to niektórzy historycy buddyzmu, z tego zapisu wynikałoby, że Pierwszy Patriarcha przewędrował na północ najpóźniej w roku 495, a być może nawet około roku 480.
(McRae 1986: 18-21).

Wedle tradycji Bodhidharma\index{Bodhidharma} miał otrzymać przekaz Dharmy, pochodzący w nieprzerwanej linii od indyjskiego mistrza Mahakaśjapy (skt. \textit{Mahākāśyapa}, chiń. 摩訶迦葉 \nazwisko{Móhējiāshè} lub \nazwisko{Móhējiāyè}), ucznia historycznego Buddy Siakjamuniego, Siddhārta Gautamy
(Buswell 2004: 57).

\section{Pochodzenie \textit{Sutry platformy\index{Sutra platformy 壇經}} oraz jej przekłady na język angielski}
\textit{Sutra platformy Szóstego Patriarchy} (六祖壇經 \pinyin{Liùzǔ Tánjīng}) jest apokryficznym tekstem buddyzmu Chan\index{Chan}.
...
Huineng\index{Dajian Huineng 大鑒惠能} jest w \textit{Sutrze platformy} przedstawiony jako niepiśmienny, prosty człowiek z leżącego poza zasięgiem chińskiej cywilizacji południa, choć w istocie jego nauki bazują na powszechnie znanych w VIII w. tekstach Mahajany\index{Buddyzm Mahajany}
(Huineng, Schlütter i Teiser 2012: 78).

Pełen tytuł \textit{Sutry platformy\index{Sutra platformy 壇經}} brzmi ``Doktryna nagłego oświecenia Szkoły Południowej\index{Szkoła Południowa}, Najwyższa Doskonałość Mądrości Mahajany\index{Buddyzm Mahajany}: Sutra Platformy, przekazana przez Szóstego Patriarchę Huineng\index{Dajian Huineng 大鑒惠能} w świątyni Dafan, w prefekturze Shao'' (南宗頓教最上大乘摩訶般若波羅蜜經六祖惠能大師於韶州大梵寺施法壇經 \pinyin{Nánzōng dùnjiào zuìshàng dàshèng móhēbōrě bōluómì jīng liùzǔ Huìnéng Dàshī yú Shāozhōu Dàfán Sì shīfǎ Tánjīng}).
...
\textit{Sutrę platformy\index{Sutra platformy 壇經}} zalicza się do korpusu dzieł \textit{Mahapradżniaparamity}%
...
Według tych nauk, doskonałość tylko w tej jednej paramicie wystarczy do osiągnięcia perfekcji w pozostałych pięciu. Do tego gatunku zalicza się m.in. takie dzieła, jak \textit{Sutrę diamentową} (patrz: przyp. na str. \pageref{DiamondSutra}), \textit{Sutrę serca\index{Sutra serca 心經}} (patrz: przyp. na str. \pageref{HeartSutra}), a także omawianą tu \textit{Sutrę platformy}.}.
...
(Huineng\index{Dajian Huineng 大鑒惠能} i Yampolsky 2012: 127; Huineng, Schlütter i Teiser 2012: 78).

\textit{Sutrę platformy\index{Sutra platformy 壇經}} uważa się za jedno z najważniejszych dzieł buddyzmu Chan\index{Chan}, ponieważ wprowadziła nauki o nagłym oświeceniu (頓教 \pinyin{dùnjiào}, `nagła szkoła, subityzm'), stojące w opozycji do nauk tzw. stopniowej szkoły (漸教 \pinyin{jiànjiào}), i wywołała podział szkoły Chan na odłam północny i południowy. % reference
(Buswell 2004: 347-348).%; McRae, 2004: ).

Najważniejsze z koncepcji, które wprowadziła \textit{Sutra platformy\index{Sutra platformy 壇經}}, to identyfikacja medytacji\index{medytacja} z mądrością (omówione szerzej w sekcji \textit{Nauki o medytacji} na str. \pageref{DingHui}), ***
...
Były to niektóre z powodów, dla których w roku 796 Huineng\index{Dajian Huineng 大鑒惠能} został oficjalnie obwołany szóstym patriarchą Chan\index{Chan} przez cesarską komisję, a jego dzieło stworzyło podwaliny pod dalszy rozwój szkoły Chan
(Huineng, Schlütter i Teiser 2012: 2).


\chapter{Biografie Huinenga\index{Dajian Huineng 大鑒惠能}}
...
Z owego tekstu nie wynika jednak, by był postacią szczególnie ważną dla rozwoju całej szkoły Chan\index{Chan}, wspomniano w nim natomiast, że Huineng żył i nauczał w miejscowości Caoqi (曹溪 \toponim{Cáoqī}).

Imię Huineng\index{Dajian Huineng 大鑒惠能} pojawia się również w pewnym tekście z grot Dunhuang\index{Dunhuang}%
...
Kiedy Huineng\index{Dajian Huineng 大鑒惠能} dotarł do klasztoru, Piąty Patriarcha Hongren \index{Daman Hongren 大滿弘忍}zapytał go, skąd i w jakiej sprawie przyszedł do patriarchy.
...
(Huineng\index{Dajian Huineng 大鑒惠能} i Yampolsky 2012: 128).
...
Mnisi stwierdzili zgodnie: ,,Nie ma sensu oczyszczać umysłu i zadawać sobie trudu układania wiersza dla patriarchy. Shenxiu\index{Yuquan Shenxiu 玉泉神秀} (神秀 \nazwisko{Shénxiù}), przewodniczący kongregacji, jest naszym nauczycielem.
...
(Huineng\index{Dajian Huineng 大鑒惠能} i Yampolsky 2012: 127).
...
\label{ShenxiuVerse}
\vspace*{6pt}
\footnotetext{Tekst w języku polskim przytoczony za przekładem \textit{Sutry Szóstego Patriarchy Zen\index{Zen}} nieznanego tłumacza, zamieszczonym w serwisie mahajana.net.}

O poranku, Piąty Patriarcha Hongren \index{Daman Hongren 大滿弘忍}ujrzał wiersz napisany przez Shenxiu\index{Yuquan Shenxiu 玉泉神秀} na ścianie i uznał, że wiersz ten mógł przynieść ludziom wiele pożytku. Zapłacił wówczas malarzowi, któremu zlecił namalowanie scen z sutry \textit{La\.nkāvatāra}, i odwołał zamówienie.
...
Dalszy ciąg \textit{Sutry Platformy\index{Sutra platformy 壇經}} podaje, że Huineng\index{Dajian Huineng 大鑒惠能} przebywał w Caoqi w sumie przez 40 lat.
...
% Schlütter 31
% nie atakuje Północnego Chan\index{Chan}
% Matka Wang Wei była wyznawczynią Puji

\section{Analiza biografii Huinenga\index{Dajian Huineng 大鑒惠能} zawartej w tekście \textit{Sutry Platformy\index{Sutra platformy 壇經}} z Dunhuang\index{Dunhuang}}
...
Tekst wysuwa twierdzenia, jakoby Huineng był prawowitym spadkobiercą Piątego Patriarchy Hongrena\index{Daman Hongren 大滿弘忍}, a co za tym idzie, szóstym dzierżawcą przekazu Chan\index{Chan}, pochodzącego w prostej, nieprzerwanej linii od Buddy Siakjamuniego
(Huineng, Schlütter i Teiser 2012: 25-26). % ***

McRae (2004, str. 67), uważa, że niemożliwe jest, by wydarzenia przedstawione w biografii Huinenga\index{Dajian Huineng 大鑒惠能} faktycznie miały miejsce, i należy je traktować jako ciekawą anegdotę o wyraźnym podtekście duchowym.
Za tą tezą przemawia fakt, że Shenxiu\index{Yuquan Shenxiu 玉泉神秀} był uczniem Hongrena\index{Daman Hongren 大滿弘忍} jedynie przez kilka lat w początkowym etapie działalności Piątego Patriarchy, a więc kiedy nie istniał jeszcze problem wyboru jego następcy. Shenxiu i Huineng nie przebywali w klasztorze Hongrena w tym samym czasie, a więc nie mogli współzawodniczyć w konkursie poezji.
Po drugie, w owym okresie nie istniała jeszcze koncepcja jedynego prawowitego patriarchy --- pojawiła się ona dopiero w dziełach Shenhui\index{Heze Shenhui 荷澤神會}. Ponadto historia życia Huinenga w zachowanej do dnia dzisiejszego wersji nie pojawia się w pismach Shenhui, a jako propagator Huinenga w roli Szóstego Patriarchy na pewno zapisałby tę historię, gdyby była mu znana
(Huineng i McRae 2000: xv).

Shenhui zaczął promować Huinenga\index{Dajian Huineng 大鑒惠能} jako Szóstego Patriarchę linii Chan\index{Chan} w roku 732.
Jednocześnie atakował uczniów i spadkobierców Shenxiu\index{Yuquan Shenxiu 玉泉神秀}, szczególnie Songshan Puji (嵩山普寂 \pinyin{Sōngshān Pǔjì}, 651-739), roszczącego sobie prawa do tytułu Siódmego Patriarchy (kwestia ta została opisana szerzej w rozdziale trzecim).
Między rokiem 730 a 750 Shenhui\index{Heze Shenhui 荷澤神會} spisał biografię Huinenga, zbliżoną do zawartej w \textit{Sutrze Platformy\index{Sutra platformy 壇經}}.
Najwcześniejsza jej wersja podają jedynie, że Huineng był Szóstym Patriarchą i otrzymał od Hongrena\index{Daman Hongren 大滿弘忍}, swojego mistrza, szatę --- insygnium patriarchatu --- oraz przekaz Dharmy.
...
W późniejszym okresie hagiografia Huinenga\index{Dajian Huineng 大鑒惠能} została uzupełniona opowieścią o konkursie poezji, w którym Huineng miał pokonać Shenxiu\index{Yuquan Shenxiu 玉泉神秀}, jednoznacznie dowodząc wyższości subityzmu Szkoły Południowej\index{Szkoła Południowa} nad stopniową ścieżką Szkoły Północnej\index{Szkoła Północna}.
...
W \textit{Sutrze platformy\index{Sutra platformy 壇經}} w wielu miejscach pojawia się imię Shenhui\index{Heze Shenhui 荷澤神會}, co wskazuje, że najprawdopodobniej została ona spisana wkrótce po jego śmierci.
...
Historyczny Huineng\index{Dajian Huineng 大鑒惠能} był postacią stosunkowo mało znaną i prawdopodobnie dlatego Shenhui\index{Heze Shenhui 荷澤神會} wybrał go jako bohatera swoich historii.
...
Wiedział o nim jedynie, że był uczniem Hongrena\index{Daman Hongren 大滿弘忍}, nauczycielem Dharmy o regionalnym zasięgu działalności, zamieszkałym w Shaozhou, na ziemiach oddalonych od serca chińskiej cywilizacji.
Prawdopodobnie był mistrzem medytacji\index{medytacja} nauczającym o nagłym oświeceniu, ale wbrew pełnym wyolbrzymień opowieściom, zawartym w \textit{Sutrze platformy\index{Sutra platformy 壇經}}, już za jego życia idee te nie uchodziły za nic nadzwyczajnego.
...
Ważnym aspektem nauk Shenhui\index{Heze Shenhui 荷澤神會}, przypisywanych Huinengowi\index{Dajian Huineng 大鑒惠能}, jest odejście od sutry \textit{La\.nkā\-vatāra\index{Sutra La\.nkāvatāra}} na rzecz \textit{Sutry Diamentowej\index{Sutra diamentowa 金剛經}}, która zyskiwała na popularności w VIII w.
O tym, jak wielką rolę odgrywała ona dla Shenhui, świadczą liczne odniesienia do niej w \textit{Sutrze Platformy\index{Sutra platformy 壇經}}.
W tekście jest wysunięta również teza, jakoby to \textit{Sutra Diamentowa}, a nie \textit{La\.nkāvatāra}, była podstawą nauk przekazywanych przez patriarchów, od Bodhidharmy\index{Bodhidharma} do Huinenga.
Twierdzeniom tym zaprzeczają jednak inne teksty na temat linii przekazu Chan\index{Chan}, takie jak ``Kontynuowane biografie wybitnych mnichów\index{Kontynuowane biografie wybitnych mnichów 續高僧傳}'', ``Annały przekazu skarbu Dharmy'' i ``Zapisy mistrzów i uczniów w przekazie Sutry La\.nkāvatāra'' (楞伽師資記 \pinyin{Léngqié shīzī jì}).
Symboliczne odejście od sutry \textit{La\.nkāvatāra} jest też zaznaczone w biografii Huinenga w \textit{Sutrze Platformy} w miejscu, w którym Piąty Patriarcha Hongren \index{Daman Hongren 大滿弘忍}zrezygnował z wykonania malowideł ze scenami z sutry \textit{La\.nkāvatāra} na rzecz wiersza Shenxiu\index{Yuquan Shenxiu 玉泉神秀} (Huineng i Yampolsky 2012: 34; McRae 2004: ***).

Interesujące jest, jak w \textit{Sutrze platformy\index{Sutra platformy 壇經}} połączono nauki, pochodzące z różnych systemów filozofii buddyjskiej.
Według filozofii Madhjamiki oraz związanego z nią kanonu sutr Pradżniaparamity, takich jak \textit{Sutra diamentowa\index{Sutra diamentowa 金剛經}} czy \textit{Sutra serca\index{Sutra serca 心經}}, rozwinięcie mądrości pradżni jest ostatecznym celem praktyki duchowej.
Osiągnięcie go równa się zrozumieniu pustej natury wszystkich zjawisk, czyniąc zbędnymi nauki o naturze buddy.
Natomiast w systemie \textit{Tathagathagarbha}, z którym związana jest sutra \textit{La\.nkā\-vatāra\index{Sutra La\.nkāvatāra}}, pradżnia jest wyłącznie zdolnością umysłu, zaś głównym obiektem zainteresowania jest natura buddy, obecna w umyśle wszystkich istot.
...
W dziełach Shenhui\index{Heze Shenhui 荷澤神會} pojawiły się też dwie opowieści, powielone w późniejszych dziełach. Pierwsza z nich, zapisana zarówno w \textit{Sutrze Platformy\index{Sutra platformy 壇經}}, jak i \textit{Putidamo Nanzong ding shifei lun}, dotyczyła Bodhidharmy\index{Bodhidharma} i cesarza Liang Wudi (梁武帝 \nazwisko{Liáng Wǔdì}).
...
Mistrz odparł: ,,Nie zgromadziłeś zasługi.'' Miał przez to na myśli, że cesarz, nie podążając za właściwą ścieżką, szukał jedynie błogosławieństw, a nie prawdziwej zasługi. Cesarz, nie rozumiejąc tej nauki, był nią rozczarowany i wygnał Bodhidharmę ze swego państwa. Następnie mistrz udał się do państwa Wei\label{LiangWuDi} (Huineng\index{Dajian Huineng 大鑒惠能} i Yampolsky 2012: 27, 155-156).

% T48n2007_p0341a24(10)║朕一生未來造寺布施供養有有功德否。達磨答言。並無功德。
% T48n2007_p0341a25(03)║武帝惆悵遂遣。達磨出境。未審此言。請和尚說。
% a w Wei spotkał Huike\index{Dazu Huike 大祖慧可}

Inna opowieść propagowana przez Shenhui\index{Heze Shenhui 荷澤神會} dotyczy Bodhidharmy\index{Bodhidharma} oraz jego ucznia i spadkobiercy, Huike\index{Dazu Huike 大祖慧可}. Według tej historii, kiedy mistrz i uczeń spotkali się po raz pierwszy, Huike był zdeterminowany zostać uczniem Bodhidharmy, lecz ten nie chciał go przyjąć. Mistrz miał ustąpić Huike dopiero wówczas, gdy ten w dowód swej determinacji dobył miecza i demonstracyjnie uciął swoje lewe ramię. Huike został następnie głównym uczniem Bodhidharmy i odziedziczył po nim szatę. Później tę samą szatę mieli otrzymać kolejni patriarchowie: Sengcan,\index{Jianzhi Sengcan 鑑智僧璨} Daoxin,\index{Dayi Daoxin 大醫道信} Hongren,\index{Daman Hongren 大滿弘忍} aż do Huinenga\index{Dajian Huineng 大鑒惠能}. Przy pomocy tej opowieści Shenhui osiągnął dwa cele: nie tylko ustanowił szatę Bodhidharmy insygnium prawowitego patriarchy Chan\index{Chan}, lecz również podważył uznaną dotychczas linię przekazu, wiodącą od Bodhidharmy do Shenxiu\index{Yuquan Shenxiu 玉泉神秀}. Pochodzenie tych legend nie jest znane. Hu Shi uważa, że zostały one wymyślone przez Shenhui, ale równie prawdopodobne jest, że krążyły wśród ludu, a Shenhui jedynie zapisał je i wykorzystał do swoich celów (Huineng i Yampolsky 2012: 27).

\if 0
Yampolsky
Nawet jeżeli istniał Bodhidharma\index{Bodhidharma}, linia przekazu Chan\index{Chan} raczej nie istniała w nieprzerwanej formie
Chan jako taki wymyślono po czasach Hongrena\index{Daman Hongren 大滿弘忍}
biografia Huinenga\index{Dajian Huineng 大鑒惠能} ma poprzeć roszczenia
Schlütter 32
\fi

\subsection{Wiersze Shenxiu\index{Yuquan Shenxiu 玉泉神秀} i Huinenga\index{Dajian Huineng 大鑒惠能}}
Tradycyjna interpretacja wierszy Shenxiu i Huinenga, zawartych w tekście \textit{Sutry Platformy\index{Sutra platformy 壇經}} (patrz: strony \pageref{ShenxiuVerse} i \pageref{HuinengVerse}), jest prosta.
...
Tym samym, w rozumieniu Zongmi wiersze te reprezentują pogląd dwóch konkurencyjnych tradycji Chan\index{Chan}, północnej i południowej.
W późniejszym okresie była to dominująca interpretacja szkoły Chan
(McRae 2004: 63).

Takie rozumienie jest jednak nadmiernym uproszczeniem. Wiersz przypisywany Shenxiu\index{Yuquan Shenxiu 玉泉神秀} odnosi się nie tyle do stopniowej ścieżki, ile do ciągłej, bezustannej praktyki oczyszczania zwierciadła z kurzu.
Wiersz Huinenga\index{Dajian Huineng 大鑒惠能} nie opisuje natomiast poglądu nagłej ścieżki, a jedynie neguje twierdzenia, zawarte w wierszu Shenxiu.
Oprócz tego, wiersze przedstawiają dwa punkty widzenia na ten sam temat i nie mogą być interpretowane osobno
(McRae 2004: 63-64).

Opis konkursu poezji, zawarty w tekście \textit{Sutry platformy\index{Sutra platformy 壇經}}, ma za zadanie udowodnić wyższość nauk Huinenga\index{Dajian Huineng 大鑒惠能} i jego spadkobierców nad naukami Shenxiu\index{Yuquan Shenxiu 玉泉神秀}.
...
\if 0
McRae xvi
Shenxiu\index{Yuquan Shenxiu 玉泉神秀} i Huineng\index{Dajian Huineng 大鑒惠能} nie przebywali w Huangmei w tym samym czasie

McRae 62-64:
Wiersz Shenxiu\index{Yuquan Shenxiu 玉泉神秀}:
...
Wiersz Shenxiu\index{Yuquan Shenxiu 玉泉神秀} był głęboki i wyrafinowany, bo tym sposobem wiersz Huinenga\index{Dajian Huineng 大鑒惠能} jest lepszy od czegoś wybitnego; być lepszym od czegoś miernego to żadne osiągnięcie
...
Wiersze oparte na pismach Szkoły Północnej\index{Szkoła Północna} (McRae 67)
...
Jego idee nie zostały docenione za jego życia, tak jak idee Huinenga, które spopularyzowała dopiero \textit{Sutra platformy\index{Sutra platformy 壇經}}.
...
Symboliczne znaczenie miało również liczba patriarchów w linii przekazu Chan\index{Chan}. Według panującej wówczas interpretacji myśli konfucjańskiej jedynie cesarz mógł w świątyni swojej rodziny urządzić siedem izb. Linia przekazu w wersji Shenhui\index{Heze Shenhui 荷澤神會} wiodła od Bodhidharmy\index{Bodhidharma}, przez Hongrena\index{Daman Hongren 大滿弘忍}, do Huinenga\index{Dajian Huineng 大鑒惠能}. Jako spadkobierca Szóstego Patriarchy, Shenhui stawał się Siódmym Patriarchą i tym samym ustanawiał doskonałą linię Chan.
\if 0
Southern Learning
...
Z perspektywy nauk Konfucjusza Huineng\index{Dajian Huineng 大鑒惠能} był postacią godną naśladowania.
...
Sam Shenxiu\index{Yuquan Shenxiu 玉泉神秀}, rzekomy konkurent Huinenga do pozycji patriachy, pochodził ze szlachetnego rodu i był wykształcony zarówno w literaturze buddyjskiej, jak i świeckiej, a niektórzy podejrzewają nawet, że mógł być związany z rodem cesarskim
(McRae 2004: 68).

Celem takiego przedstawienia Szóstego Patriarchy było pokazanie, że każdy, nawet osoba świecka, niezależnie od pozycji społecznej, miejsca pochodzenia i wykształcenia mógł rozpoznać naturę swojego umysłu i zostać zwierzchnikiem Chan\index{Chan}.
Co za tym idzie, jeżeli oświecenie było jedynym warunkiem zostania patriachą, to czytelnik mógł oczekiwać, że wszyscy poprzednicy i następcy Huinenga\index{Dajian Huineng 大鑒惠能} również byli oświeceni.
W ten sposób szkoła Chan zyskiwała autorytet i wiarygodność (McRae 2004: 69).


\chapter{Analiza tekstu \textit{Sutry Platformy\index{Sutra platformy 壇經}}}

\section{Budowa Sutry}
Tekst \textit{Sutry platformy\index{Sutra platformy 壇經}} w przekładzie Philipa B. Yampolsky'ego został podzielony na 57 sekcji o różnej długości. Narratorem tekstu jest Fahai, uczeń Huinenga\index{Dajian Huineng 大鑒惠能}, nie licząc sekcji 2-11, będących autobiografią Szóstego Patriarchy w formie monologu. Pierwsze 37 sekcji zawiera nauki wygłoszone przez Huinenga w świątyni Dafan. Jak podaje tekst, wysłuchało ich zgromadzenie ponad dziesięciu tysięcy praktykujących, w tym mnichów, mniszek i ludzi świeckich, a także prefekt Shaozhou, Wei Qu (韋璩). W sekcjach 12-37 przekazane zostały ,,bezforemne nauki'' (無相戒 \pinyin{wúxiàng jiè}, ang. \textit{precepts of formlessness} lub \textit{formless precepts}).

W sekcjach 39-44 zamieszczono anegdoty dotyczące najważniejszych spadkobierców Huinenga\index{Dajian Huineng 大鑒惠能}, takich jak Fahai, Zhichang (智常 \pinyin{Zhìcháng}), Fada (法達 \pinyin{Fǎdá}) i Shenhui\index{Heze Shenhui 荷澤神會}. Sekcje 45-47 to nauki udzielone dziesięciu bliskim uczniom. Sekcje 48-57 opisują okoliczności śmierci Szóstego Patriarchy, a także: nauki, które przekazał swym uczniom w formie wierszy bezpośrednio przed śmiercią; informacje o następcach Huinenga, dalszych losach \textit{Sutry platformy\index{Sutra platformy 壇經}} i przekazie nauk szkoły Chan\index{Chan}.

\section{Nauki o medytacji\index{medytacja}}
...
(Huineng\index{Dajian Huineng 大鑒惠能} i Yampolsky 2012: 137).
...
(Huineng\index{Dajian Huineng 大鑒惠能} i Yampolsky 2012: 137-138).
...
Według Huinenga\index{Dajian Huineng 大鑒惠能}, praktykujący Chan\index{Chan} nie powinien koncentrować się ani na umyśle, ani na czystości, nie powinien też mówić o niewzruszoności. Twierdzi, że umysł sam w sobie jest zwodniczy, jest jedynie iluzją i jako taki nie powinien być obiektem medytacji\index{medytacja}. Również sama koncentracja na czystości nie przynosi spodziewanych rezultatów. W sytuacji, gdy praktykujący nie zrozumie, że natura umysłu jest sama w sobie doskonała i czysta, taka praktyka stwarza jedynie kolejne złudzenia i sztywne koncepcje, jeśli praktykujący. Jedynym powodem, dla którego istoty nie są w stanie postrzegać swojej natury w ten sposób, są błędne poglądy i zaciemnienia (Huineng i Yampolsky 2012: 139-140).

Prawidłowa praktyka medytacji\index{medytacja} siedzącej (坐禪 \pinyin{zuòchán}) została przez Huinenga\index{Dajian Huineng 大鑒惠能} zdefiniowana jako niepodążanie za myślami oraz postrzeganie własnej prawdziwej natury bez rozproszenia. Natomiast ,,medytacja Chan\index{Chan}'' (禪定 \pinyin{chándìng}) oznacza według niego niezależność od zewnętrznych zjawisk oraz unikanie pomieszania w umyśle (Huineng i Yampolsky 2012: 140-141).

\section{Bezforemne nauki}
W sekcjach 20-37 \textit{Sutry platformy\index{Sutra platformy 壇經}} przekazane zostały tzw. ,,bezforemne nauki'', jeden z najważniejszych aspektów tekstu. W sekcji 20. Szósty Patriarcha naucza o obecności trzech ciał buddy%
...
(Huineng\index{Dajian Huineng 大鑒惠能} i Yampolsky 2012: 141-143).
...
(Huineng\index{Dajian Huineng 大鑒惠能} i Yampolsky 2012: 143-144).
...
Huineng\index{Dajian Huineng 大鑒惠能} podkreśla tu, że Dharmę należy praktykować w swoim umyśle, a nie jedynie bezmyślnie powtarzać.
W tradycji Chan\index{Chan} recytacja sutr z gatunku \textit{Mahapradżniaparamity}, takich jak \textit{Sutra Diamentowa\index{Sutra diamentowa 金剛經}} lub \textit{Sutra Serca\index{Sutra serca 心經}}%
...
Huineng\index{Dajian Huineng 大鑒惠能} naucza tu, że gdy medytujący pozbędzie się przeszkadzających emocji, zostanie tylko \textit{pradżnia}, która jest zawsze obecna i nieoddzielna od umysłu.
...
(Huineng\index{Dajian Huineng 大鑒惠能} i Yampolsky 2012: 149-150).

W sekcji 31. Huineng\index{Dajian Huineng 大鑒惠能} naucza o roli nauczyciela duchowego na ścieżce.
...
Sekcja 32. zawiera zalecenia Huinenga\index{Dajian Huineng 大鑒惠能} na temat przekazu doktryny Nagłego Oświecenia w następnych pokoleniach.
...
W sekcji 33. Huineng\index{Dajian Huineng 大鑒惠能} przekazał swoim uczniom ,,wiersz usuwający negatywną karmę'' (滅罪頌 \pinyin{miè zuì sòng}).
...
Według Huinenga\index{Dajian Huineng 大鑒惠能}, zasługa powstaje z umysłu i w umyśle, a więc jedynym sposobem na jej zgromadzenie jest spoglądanie we własną naturę buddy, w \textit{dharmakāya}, i szacunek dla Trzech Klejnotów%
...
W sekcji 35. zawarto nauki Huinenga\index{Dajian Huineng 大鑒惠能} dotyczące praktyk Czystej Krainy, związanych z Buddy Amitābhą\index{Budda Amitābha}, które w jego czasach były już w Chinach szeroko rozpowszechnione.
...
Huineng\index{Dajian Huineng 大鑒惠能} porównuje tu mnicha, który nie żyje w zgodzie z naukami, do złego człowieka z Zachodu.
Człowieka świeckiego, praktykującego Dharmę, przyrównuje natomiast do dobrego człowieka ze Wschodu.
W czasach, gdy powstawała \textit{Sutra platformy\index{Sutra platformy 壇經}}, większość mnichów wywodziła się z bogatych rodzin.
Pouczenia zawarte w tej sekcji czynią jednak z Chan\index{Chan}u uniwersalną ścieżkę, którą może podążać każdy, niezależnie od statusu społecznego.
W tym fragmencie Szósty Patriarcha przekazuje również „bezforemny wiersz” (無相頌) dotyczący praktyki w życiu codziennym.
Mówi w nim, że biegłość w nauczaniu i w medytacji\index{medytacja} (說通及心通) są niczym słońce i pustka.
...
Po wygłoszeniu tych nauk Huineng\index{Dajian Huineng 大鑒惠能} udał się do Caoqi, zaznaczając, że jeśli ktokolwiek będzie miał wątpliwości lub pytania dotyczące , powinien odwiedzić go na tej górze, a wtedy mistrz będzie mógł je rozwiać % 同見佛世
(Huineng i Yampolsky 2012: 161-162).

W sekcji 38. opowiedziano dalsze dzieje życia Szóstego Patriarchy.
Według tego zapisu Huineng\index{Dajian Huineng 大鑒惠能} przez następne 40 lat nauczał ludzi z Shaozhou i Guangzhou.
Tekst podaje, że mistrz miał wiele tysięcy uczniów, zarówno mnichów, jak i świeckich praktykujących.
Według tego zapisu, osią jego nauk był przekaz \textit{Sutra platformy\index{Sutra platformy 壇經}}, a w późniejszych pokoleniach jedynie ci, którzy otrzymali ten przekaz, mieli być ortodoksyjnymi dzierżawcami Południowej Szkoły.
...
Sekcja 39. mówi o pochodzeniu nazw ,,Szkoła Północna\index{Szkoła Północna}'' i ,,Szkoła Południowa\index{Szkoła Południowa}''.
Według tego zapisu, wzięły się one stąd, że mistrz Shenxiu\index{Yuquan Shenxiu 玉泉神秀} nauczał w świątyni Yuquan w pobliżu miasta Dangyang w obecnej prowincji Hubei, a więc na północy Chin.
Huineng\index{Dajian Huineng 大鑒惠能} zaś nauczał w Caoqi, w pobliżu Shaozhou, a więc w południowej części kraju.
Chociaż w Dharmie nie ma podziałów, ludzie z Południa i Północy różnią się od siebie; stąd podział na dwie szkoły Chan\index{Chan}.
...
\section{Opowieści o uczniach Huinenga\index{Dajian Huineng 大鑒惠能}}
W sekcjach 40-44 \textit{Sutry platformy\index{Sutra platformy 壇經}} zawarto informacje o spadkobiercach Huinenga, takich jak Shenhui\index{Heze Shenhui 荷澤神會}, Fada czy Zhichang.

Sekcje 40. i 41. opowiadają o przybyciu do Szóstego Patriarchy mnicha imieniem Zhicheng (志誠 \pinyin{Zhìchéng}).
Anegdota ta ma dowodzić wyższości Szkoły Południowej\index{Szkoła Południowa} nad Szkołą Północną\index{Szkoła Północna}.
Jak podaje ten fragment, pewnego razu Shenxiu\index{Yuquan Shenxiu 玉泉神秀} usłyszał o Huinengu i rzekomej wyższości jego nauk.
...
Kiedy ten przybył do świątyni Huinenga\index{Dajian Huineng 大鑒惠能} i usłyszał jego nauki, w jednej chwili rozpoznał naturę swojego umysłu i osiągnął oświecenie.
...
Wówczas Szósty Patriarcha spytał Zhichenga o szczegóły doktryny Shenxiu\index{Yuquan Shenxiu 玉泉神秀}, a dokładniej, jakie były jego nauki na temat moralności (właściwego postępowania), medytacji\index{medytacja} i mądrości (戒定惠 \pinyin{jiè dìng huì}, dosł. `ślubowania, medytacja i mądrość').
...
Huineng\index{Dajian Huineng 大鑒惠能} powiedział mu, że w istocie są to dobre nauki, ale reprezentują powolną ścieżkę, przeznaczoną dla mniej zdolnych słuchaczy, w odróżnieniu od jego własnej, szybkiej ścieżki, którą mogli praktykować jedynie wybitni uczniowie.
...
W związku z tym udał się do Caoqi, by poprosić o wyjaśnienia  Huinenga\index{Dajian Huineng 大鑒惠能}.
...
Huineng\index{Dajian Huineng 大鑒惠能} powiedział natomiast, że prawdziwym znaczeniem tego określenia jest odrzucenie fałszywych, dualistycznych poglądów, takich jak lgnięcie do formy lub pustości.
...
Chociaż Budda nauczał jedynie o trzech pojazdach, Huineng\index{Dajian Huineng 大鑒惠能} mówił również o Najwyższym Pojeździe (最上乘 \pinyin{zuì shàng chéng}).
...
Shenhui zapytał Szóstego Patriarchę, czy widzi coś, gdy siedzi w medytacji\index{medytacja}.
...
Huineng\index{Dajian Huineng 大鑒惠能} wyjaśnił, że tak samo on sam, gdy siedzi w medytacji, widzi swoje błędy, a jednocześnie nie widzi błędów innych ludzi.
...
\textit{Sutra platformy\index{Sutra platformy 壇經}} podaje, że po tym spotkaniu Shenhui został uczniem Huinenga i zamieszkał w Caoqi
(Huineng i Yampolsky 2012: 169-170).

\section{Nauki przekazane dziesięciu głównym uczniom}
W sekcjach 45-47 \textit{Sutry platformy\index{Sutra platformy 壇經}} zapisano nauki przekazane przez Szóstego Patriarchę  dziesięciu najbliższym uczniom: Fahai, Zhicheng, Fada, Zhichang, Zhitong (志通 \nazwisko{Zhìtōng}), Zhiche (志徹 \nazwisko{Zhìchè}), Zhidao (志道 \nazwisko{Zhìdào}), Fazhen (法珍 \nazwisko{Fǎzhēn}), Faru\index{Faru 法如} i Shenhui\index{Heze Shenhui 荷澤神會}.
...
Przekazując te wyjaśnienia, Huineng\index{Dajian Huineng 大鑒惠能} miał ogłosić, że po jego śmierci to na nich, jako jego uczniach, spoczywać będzie obowiązek nauczania przyszłych pokoleń.
...
Składają się na nie: pięć skandh (skt. \textit{skandha}, 五蘊 \pinyin{wǔ yùn}, w \textit{Sutrze platformy\index{Sutra platformy 壇經}} zapisywane 五蔭 \pinyin{wǔ yìn}; czasem tłumaczone jako ,,skupiska'') oraz osiemnaście dhātu (skt., chiń. 十八界 \pinyin{shíbā jiè} `osiemnaście sfer'), w których z kolei zawiera się dwanaście podstaw zmysłowych (skt. \nohyphens{\itshape āyatana}, chiń. \pinyin{shíèr rù}).
...
Huineng\index{Dajian Huineng 大鑒惠能} wyjaśnił również, że wszystkie zjawiska, w tym dwanaście podstaw zmysłowych i sześć świadomości, powstają w przestrzeni umysłu.
...
Sekcja 46. zawiera szczegółowe wyjaśnienia, dotyczące ,,trzydziestu sześciu konfrontacji aktywności''. W tym fragmencie tekstu Huineng\index{Dajian Huineng 大鑒惠能} wyliczył: pięć konfrontacji zewnętrznych zjawisk, dwanaście konfrontacji języka i cech przedmiotów oraz dziewiętnaście konfrontacji aktywności powstałych z natury umysłu.
...
W sekcji 47. zawarto kolejną informację o przekazie nauk Chan\index{Chan} za pomocą \textit{Sutry platformy\index{Sutra platformy 壇經}}. % Fahai sekcja 38
Według tego zapisu ten, kto nie otrzymał przekazu tekstu, nie posiadł podstaw nauk Huinenga\index{Dajian Huineng 大鑒惠能}.
...
\section{Śmierć Huinenga\index{Dajian Huineng 大鑒惠能} i jej następstwa}
Sekcje 48-54 \textit{Sutry platformy\index{Sutra platformy 壇經}} opisują okoliczności śmierci Huinenga, nauki wygłoszone przez niego bezpośrednio przed odejściem, oraz przekaz nauk w dalszych pokoleniach.
...
Huineng\index{Dajian Huineng 大鑒惠能} miał pożegnać się z uczniami na miesiąc przed śmiercią.
...
Sekcja 49. zawierają informacje o linii przekazu nauk Chan\index{Chan}.
...
Wzmianka ta odnosi się do przemowy wygłoszonej przez Shenhui\index{Heze Shenhui 荷澤神會} w roku 732 w świątyni Dayun (大雲寺) w miejscu zwanym Huatai (滑臺 \toponim{Huátái}) w obecnej prowincji Henan\index{Prowincja Henan 河南省} (patrz: str. \pageref{Huatai}).
...
Następnie tekst sutry podaje pięć krótkich wierszy, które pięciu patriarchów przed nim --- Bodhidharma\index{Bodhidharma}, Huike\index{Dazu Huike 大祖慧可}, Sengcan,\index{Jianzhi Sengcan 鑑智僧璨} Daoxin \index{Dayi Daoxin 大醫道信}i Hongren \index{Daman Hongren 大滿弘忍}--- mieli przekazać wraz z szatą i Dharmą
(Huineng\index{Dajian Huineng 大鑒惠能} i Yampolsky 2012: 176-178).

W sekcji 50. Huineng\index{Dajian Huineng 大鑒惠能} wygłosił dwa wiersze, rzekomo zainspirowane naukami Bodhidharmy\index{Bodhidharma}.
...
Sekcja 51. opisuje linię przekazu szkoły nagłego oświecenia, prowadzącej od siedmiu buddów, przez dwudziestu ośmiu patriarchów Indii i pięciu Chin, do Huinenga\index{Dajian Huineng 大鑒惠能}.
...
(Huineng\index{Dajian Huineng 大鑒惠能} i Yampolsky 2012: 179-180).

W sekcji 53. Huineng\index{Dajian Huineng 大鑒惠能} przekazał ,,Wiersz o prawdziwym buddzie w naturze umysłu i osiągnięciu wyzwolenia'' (自性真佛解脫頌 \pinyin{zìxìng zhēn fó jiětuō sòng}).
...
(Huineng\index{Dajian Huineng 大鑒惠能} i Yampolsky 2012: 182).

\section{Zapisy o przekazie \textit{Sutry platformy\index{Sutra platformy 壇經}}}
...
Sekcja 56. opisuje warunki, które musi spełnić przyszły dzierżawca nauk Chan\index{Chan}: powinien być obdarzony ponadprzeciętną mądrością i wielkim współczuciem oraz mieć zaufanie do nauk Buddy.
...
\textit{Sutra platformy\index{Sutra platformy 壇經}} kończy się zachętą skierowaną do wszystkich praktykujących, by ze wszech miar starali się zrozumieć i urzeczywistnić nauki
(Huineng\index{Dajian Huineng 大鑒惠能} i Yampolsky 2012: 183).


\chapter{Historyczne reperkusje \textit{Sutry platformy\index{Sutra platformy 壇經}}}
\textit{Sutra platformy} pozostaje jednym z najbardziej popularnych i wpływowych tekstów buddyzmu Chan\index{Chan} do dnia dzisiejszego. Jej publikacja stanowi punkt kulminacyjny w historii buddyzmu Chan, a analizie zawartych w niej nauk i opowieści poświęcono wiele prac naukowych.

\if 0
Twierdził, że Szkoła Północna\index{Szkoła Północna}, której przewodzili Shenxiu\index{Yuquan Shenxiu 玉泉神秀} i Puji, nie była autentyczna, gdyż propagowała nauki stopniowej ścieżki. Prawdziwe, ponadczasowe nauki buddy, tzn. nauki o nagłym oświeceniu, znane również jako subityzm, miały być przekazywane w południowym Chan\index{Chan}.

Jednym z najważniejszych dzieł Shenhui\index{Heze Shenhui 荷澤神會}, które zachowały się do dzisiejszych czasów, jest odnaleziony w Dunhuang\index{Dunhuang} tekst, zatytułowany \pinyin{Nanyang heshang wenda za zheng yi} (南陽和尚問答雜徵義 \textit{Nányáng héshang wèndá zá zhēngyì}), obecnie znany lepiej pod nazwą ``Cytaty Shenhui'' (神會語錄 \pinyin{Shénhuì yǔlù}).
Jego ataki na Szkołę Północną\index{Szkoła Północna} zostały opisane przez Dugu Pei (獨孤沛) w dziele zwanym \textit{Putidamo Nanzong ding shifei lun} (菩提達摩南宗定是非論 \pinyin{Pútídámó Nánzōng dìng shìfēi lùn}).
...
W dziełach Shenhui pojawiały się twierdzenia, jakoby Puji wysłał swojego ucznia, niejakiego Zhang Xingchang (張行昌), do Shaozhou, z poleceniem ucięcia głowy zwłokom Huinenga\index{Dajian Huineng 大鑒惠能}.
Twierdził też, że inny uczeń Puji, imieniem Wu Pingyi (武平一), wymazał inskrypcję na steli poświęconej Huinengowi i wstawił tam własną, podającą Shenxiu\index{Yuquan Shenxiu 玉泉神秀} jako prawowitego Szóstego Patriarchę.

Kim był Shenxiu\index{Yuquan Shenxiu 玉泉神秀} i czym zasłużył sobie na osobiste ataki Shenhui\index{Heze Shenhui 荷澤神會}? Yampolsky (2012, str. 15-16) podaje, że na przełomie VII i VIII w. Shenxiu był uważany za jednego z najbardziej znaczących i najwybitniejszych mistrzów Chan\index{Chan}.
...
O ile we wszystkich innych dziełach z tego okresu jest wymieniony jako uczeń Hongrena\index{Daman Hongren 大滿弘忍}, ``Annały'' podają, że był uczniem Faru\index{Faru 法如}, a ten --- Hongrena. Według tej biografii pochodził z miasta Daliang (大梁 \toponim{Dàliáng}), obecnie Kaifeng (開封 \toponim{Kāifēng}) w prowincji Henan\index{Prowincja Henan 河南省} (河南 \toponim{Hénán}) i był członkiem rodu Li.
...
W wieku 46 lat udał się do Hongrena\index{Daman Hongren 大滿弘忍}, a ten natychmiast poznał się na jego talencie.
...
\section{Podział Chan\index{Chan} na Szkołę Północną\index{Szkoła Północna} i Południową}
...
Jak podaje \textit{Putidamo nanzong ding shifei lun}, w roku 732 Shenhui\index{Heze Shenhui 荷澤神會} zorganizował otwartą konferencję buddyjską w świątyni Dayun w miejscu zwanym Huatai w obecnej prowincji Henan\index{Prowincja Henan 河南省}.\label{Huatai}
...
W późniejszym czasie Szkoła Południowa\index{Szkoła Południowa} używała tego faktu na dowód swej wyższości nad Szkołą Północną\index{Szkoła Północna}, była to jednak manipulacja, gdyż mistrz Chongyuan nie reprezentował żadnej ze szkół
(Shi 2008: 200).

Na konferencji w Huatai Shenhui\index{Heze Shenhui 荷澤神會} zarzucał swoim przeciwnikom, że uzurpowali sobie prawo do linii przekazu patriarchatu, oraz że przeinaczyli istotę buddyzmu, nauczając błędnej, stopniowej ścieżki.
W rzeczywistości, Shenxiu\index{Yuquan Shenxiu 玉泉神秀} opierał swoje nauki na tych samych podstawowych ideach buddyzmu Mahajany\index{Buddyzm Mahajany}, co Shenhui.
...
Jednak w doktrynie Szkoły Północnej\index{Szkoła Północna}, opartej głównie na sutrze \textit{La\.nkā\-vatāra\index{Sutra La\.nkāvatāra}}, kładziono nacisk na praktyki przygotowawcze.
Ich zadaniem było oczyszczenie umysłu z zaciemnień, postrzeganych w tej tradycji jako istniejące i rzeczywiste.
Tymczasem Szkoła Południowa\index{Szkoła Południowa} głosiła pustość wszystkich myśli i zjawisk.
...
W \textit{Sutrze platformy\index{Sutra platformy 壇經}} dychotomię tę ilustrują ostatnie dwa wersy wiersza Huinenga\index{Dajian Huineng 大鑒惠能}: ,,W rzeczywistości nie ma niczego, / Cóż miałoby przyciągać jakikolwiek kurz?''
...
W roku 720 Shenhui\index{Heze Shenhui 荷澤神會} przebywał w miejscowości Nanyang nieopodal Luoyangu\index{Luoyang 洛陽}, gdzie nauczał medytacji\index{medytacja}.

\section{Dalszy podział Szkoły Południowej\index{Szkoła Południowa}}
Spośród uczniów Huinenga\index{Dajian Huineng 大鑒惠能}, najbardziej wpływowi byli Qingyuan Xingsi (青原行思 \nazwisko{Qīngyuán Xíngsī}) oraz Nanyue Huairang (南嶽懷讓 \nazwisko{Nányuè Huáiràng}).
...
Jego głównymi uczniami byli Daojun (道峻 \nazwisko{Dàojùn}), Shenzhao (神照 \nazwisko{Shénzhào}) oraz Mazu Daoyi\index{Mazu Daoyi 馬祖道一} (馬祖道一 \nazwisko{Mǎzǔ Dàoyī}).

Mazu Daoyi\index{Mazu Daoyi 馬祖道一} (709-788) odwiedził Hengshan w roku 735.
W ``Antologii gmachu patriarchów'' opisano
Huairang udzielił mu nauki: ,,Polerując cegłę, nie zrobisz z niej lustra; jak można osiągnąć oświecenie, praktykując medytację\index{medytacja} \textit{zuochan}?'' (磨磚既不成鏡，坐禪豈得成佛)
% Tu będzie o jego doktrynie
Za czasów cesarza Tang Daizong (唐代宗) zebrał uczniów w świątyni Kaiyuan Si (開元寺), obecnie (佑民寺) w mieście Nanchang (南昌), stolicy prowincji Jiangxi\index{Prowincja Jiangxi 江西省}.
Założony przez niego odłam Chan\index{Chan}u nazywa się szkołą Hongzhou
Daoyi miał bardzo wielu uczniów, którzy rozprzestrzenili jego nauki dalej, a następnie utworzyli szkoły Linji oraz Guiyang.

Szkoła Shenxiu\index{Yuquan Shenxiu 玉泉神秀} była popularna na północy Chin, podupadła po śmierci głównych uczniów Shenxiu: Songshan Puji i Dazhi Yifu (大智義福), by w końcu wygasnąć. % sprawdź kiedy
\if 0
Doczytać o rebelii An Lushana!

McRae 1986: 3
Sutra platformy\index{Sutra platformy 壇經} napisała historię Chan\index{Chan} od nowa; wskazuje na to pominięcie roli Shenhui\index{Heze Shenhui 荷澤神會}
W początkowej fazie istnienia Południowej Szkoły, była ona mało znana; sutra wyjaśnia to długim czasem, jaki Huineng\index{Dajian Huineng 大鑒惠能} spędził, ukrywając się u myśliwych
Lankavatara => Diamentówka
McRae 1986: 5
Szkoła Południowa\index{Szkoła Południowa} twierdziła, że posiada nauki niedualne
...
Zongmi usystematyzował różne interpretacje Chan, Szkoła Północna\index{Szkoła Północna} była najniżej
wykładnia 宗密 NS na początku była popularna, ale potem została niemal całkowicie wyparta przez SS, bo prawowitym spadkobiercą był Huineng, a nie Shenxiu\index{Yuquan Shenxiu 玉泉神秀}
Nie ma dobrych badań nt. NS

17 Pierwsze wzmianki o Bodhidharmi\index{Bodhidharma}e w 洛陽伽藍記, to był tekst, w którym ludzie z różnych stron świata przyjeżdżali do Luoyangu\index{Luoyang 洛陽}, by zachwycać się jego architekturą
...
Dumoulin 1963: 70
W czasie, kiedy Bodhidharma\index{Bodhidharma} przyniósł Chan\index{Chan} do Chin, na północy Chin był Buddhabhadra, a na południu szkoła 三论
Sanlun interesowała się Pradżniaparamitą Nagardżuny

79: 弘忍 rozwijał własne metody medytacji\index{medytacja} w oparciu o sutry Avatamsaka (華嚴)

Dumoulin 81
Pierwsza schizma w tradycji Chan\index{Chan}
SS wygrała walkę o dominację, bo NS nie rozwijało się po śmierci uczniów Shenxiu\index{Yuquan Shenxiu 玉泉神秀}, a SS publikowało wiele koanów i kronik
w 700 Shenxiu polecił cesarzowi zaprosić Huinenga\index{Dajian Huineng 大鑒惠能} do stolicy
...
中國禪宗史 115：
W sutrze jest napisane, że Huineng\index{Dajian Huineng 大鑒惠能} 先天二年八月三日滅度 oraz 春秋七十有六, ale są stele, które mówią co innego i przesuwają datę śmierci o 3 lata
《曹溪大師別傳》
