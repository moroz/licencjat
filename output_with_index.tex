...
Przybywszy do Luoyangu, Pierwszy Patriarcha miał się zachwycać pięknem tamtejszych świątyń, a zwłaszcza jednej, zwanej Yongning Si\index{Yongning Si 永寧寺} (永寧寺 \pinyin{Yǒngníng Sì} `Świątynia Wiecznego Spokoju').
...
Huineng\index{Dajian Huineng 大鑒惠能} jest w \textit{Sutrze platformy} przedstawiony jako niepiśmienny, prosty człowiek z leżącego poza zasięgiem chińskiej cywilizacji południa, choć w istocie jego nauki bazują na powszechnie znacych w VIII w. tekstach Mahajany\index{Buddyzm Mahajany}
...
% Schlütter 31
% Wang Wei 王維 napisał epitafium dla Huinenga\index{Dajian Huineng 大鑒惠能}, w którym pojawia się postać mnicha Yinzonga, który miał ostrzyc głowę Huinengowi
...
Obecnie uważa się, że autobiograficzny monolog Huinenga, przytoczony w \textit{Sutrze Platformy}, nie jest autentyczną historią jego życia, a jedynie hagiografią. Tekst wysuwa twierdzenia, jakoby Huineng miał być prawowitym spadkobiercą Piątego Patriarchy Hongrena\index{Daman Hongren 大滿弘忍}, szóstym dzierżawcą przekazu Chan\index{Chan}, pochodzącego w prostej, nieprzerwanej linii od samego historycznego Buddy. (Huineng, Schlütter i Teiser 2012: 25-26). % ***

Shenhui w 732 roku zaczął promować Huinenga\index{Dajian Huineng 大鑒惠能} jako Szóstego Patriarchę linii Chan\index{Chan} i jednocześnie atakował uczniów i spadkobierców Shenxiu\index{Yuquan Shenxiu 玉泉神秀}, szczególnie Songshan Puji (嵩山普寂 \pinyin{Sōngshān Pǔjì}, 651-739), roszczącego sobie prawa do tytułu Siódmego Patriarchy. Twierdził, że Szkoła Północna\index{Szkoła Północna}, której przewodzili Shenxiu i Puji, nie była autentyczna, gdyż propagowała nauki stopniowej ścieżki. Prawdziwe, ponadczasowe nauki buddy, tzn. nauki o nagłym oświeceniu, znane również jako subityzm, miały być przekazywane w południowym Chan. Znamienne jest to, że w pismach Shenhui\index{Heze Shenhui 荷澤神會} nie było żadnej wzmianki o konkursie poezji ani o dwóch wierszach, co świadczy o tym, iż fragmenty te zostały dodane po jego śmierci. O ile w tekście \textit{Sutry platformy\index{Sutra platformy 壇經}} zawarto nauki Shenhui i jego spadkobierców, jego wkład w powstanie sutry został w tekście przemilczany (Huineng, Schlütter i Teiser 2012: 32-33; Huineng i Yampolsky 2012: 26, 28; McRae 2004: 63).
...
Prawdopodobnie był on mistrzem medytacji\index{medytacja} nauczającym o nagłym oświeceniu, ale mimo tego, co możemy przeczytać w \textit{Sutrze platformy\index{Sutra platformy 壇經}}, już za czasów jego życia doktryna ta nie uchodziła za nic nadzwyczajnego.
...
W późniejszym okresie, tj. po śmierci Shenxiu\index{Yuquan Shenxiu 玉泉神秀}, historia życia Huinenga\index{Dajian Huineng 大鑒惠能} została uzupełniona opowieścią o konkursie poezji, w którym Huineng miał pokonać Shenxiu, jednoznacznie dowodząc wyższości subityzmu Szkoły Południowej\index{Szkoła Południowa} nad stopniową ścieżką Szkoły Północnej\index{Szkoła Północna}.
...
Kim był Shenxiu\index{Yuquan Shenxiu 玉泉神秀} i czym zasłużył sobie na osobiste ataki Shenhui\index{Heze Shenhui 荷澤神會}? W przedmowie do przekładu \textit{Sutry platformy\index{Sutra platformy 壇經}} Philipa B. Yampolsky'ego napisano, że na przełomie VII i VIII w. Shenxiu był uważany za jednego z najbardziej znaczących i najwybitniejszych mistrzów Chan\index{Chan}. Jego biografia jest szczególnie dobrze zachowana. Jej stosunkowo rzetelna wersja została zapisana w dziele ``Annały przekazu skarbu Dharmy'' (傳法寶紀 \pinyin{Chuán fǎbǎo jì}) w pozbawiony elementów fantastycznych sposób. O ile we wszystkich innych dziełach z tego okresu jest wymieniony jako uczeń Hongrena\index{Daman Hongren 大滿弘忍}, ``Annały'' podają, że był uczniem Faru\index{Faru 法如}, a ten --- Hongrena. Według tej biografii pochodził z miasta Daliang (大梁 \toponim{Dàliáng}), obecnie Kaifeng (開封 \toponim{Kāifēng}) w prowincji Henan\index{Prowincja Henan 河南省} (河南 \toponim{Hénán}) i był członkiem rodu Li (Huineng\index{Dajian Huineng 大鑒惠能} i Yampolsky 15-16). % 李
...
Między rokiem 730 a 750 Shenhui\index{Heze Shenhui 荷澤神會} spisał historię życia Huinenga\index{Dajian Huineng 大鑒惠能} zbliżoną do wersji zawartej w \textit{Sutrze Platformy\index{Sutra platformy 壇經}}, z tą różnicą, że nie było w niej jeszcze wzmianki o konkursie poezji między Shenxiu\index{Yuquan Shenxiu 玉泉神秀} i Huinengiem.
