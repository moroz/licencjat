...
Za założyciela buddyzmu Chan\index{Chan} uznaje się przybyłego z Indii mistrza Bodhidharmę.
...
Pełen tytuł \textit{Sutry platformy\index{Sutra platformy, 壇經}} brzmi ``Doktryna nagłego oświecenia Szkoły Południowej, Najwyższa Doskonałość Mądrości Mahajany\index{Buddyzm Mahajany}: Sutra Platformy, przekazana przez Szóstego Patriarchę Huineng\index{Dajian Huineng} w świątyni Dafan, w prefekturze Shao'' (南宗頓教最上大乘摩訶般若波羅蜜經六祖惠能大師於韶州大梵寺施法壇經 \pinyin{Nánzōng dùnjiào zuìshàng dàshèng móhēbōrě bōluómì jīng liùzǔ Huìnéng Dàshī yú Shāozhōu Dàfán Sì shīfǎ Tánjīng}).
...
Były to niektóre z powodów, dla których w roku 796 Huineng\index{Dajian Huineng} został oficjalnie obwołany szóstym patriarchą Chan\index{Chan} przez cesarską komisję, a jego dzieło stworzyło podwaliny pod dalszy rozwój szkoły Chan
(Huineng, Schlütter i Teiser 2012: 2).


\chapter{Biografie Huinenga\index{Dajian Huineng}}
...
\section{Biografia Huinenga\index{Dajian Huineng} według \textit{Sutry Platformy\index{Sutra platformy, 壇經}} w wersji z Dunhuang}
...
Patriarcha przywołał go do siebie w nocy i udzielił mu wyjaśnień do \textit{Sutry Diamentowej\index{Sutra diamentowa, 金剛經}}, dzięki którym Huineng\index{Dajian Huineng} natychmiast rozpoznał naturę umysłu.
...
Dalszy ciąg \textit{Sutry Platformy\index{Sutra platformy, 壇經}} podaje, że Huineng\index{Dajian Huineng} przebywał w Caoqi w sumie przez 40 lat.
...
\section{Analiza biografii Huinenga\index{Dajian Huineng} zawartej w tekście \textit{Sutry Platformy\index{Sutra platformy, 壇經}} z Dunhuang}
...
Między rokiem 730 a 750 Shenhui\index{Heze Shenhui, 荷澤神會} spisał historię życia Huinenga\index{Dajian Huineng} zbliżoną do wersji zawartej w \textit{Sutrze Platformy\index{Sutra platformy, 壇經}}, z tą różnicą, że nie było w niej jeszcze wzmianki o konkursie poezji między Shenxiu i Huinengiem.
...
Ważnym aspektem nauk Shenhui\index{Heze Shenhui, 荷澤神會}, przypisywanych Huinengowi\index{Dajian Huineng}, jest odejście od sutry \textit{La\.nkā\-vatāra} na rzecz \textit{Sutry Diamentowej\index{Sutra diamentowa, 金剛經}}, która zyskiwała na popularności w VIII w.
...
Twierdzeniom tym zaprzeczają jednak inne teksty na temat linii przekazu Chan\index{Chan}, takie jak ``Kontynuowane biografie wybitnych mnichów'', ``Annały przekazu skarbu Dharmy'' i ``Zapisy mistrzów i uczniów w przekazie Sutry La\.nkāvatāra'' (楞伽師資記 \pinyin{Léngqié shīzī jì}).
...
W dziełach Shenhui\index{Heze Shenhui, 荷澤神會} pojawiły się też dwie opowieści, powielone w późniejszych dziełach. Pierwsza z nich, zapisana zarówno w \textit{Sutrze Platformy\index{Sutra platformy, 壇經}}, jak i \textit{Putidamo Nanzong ding shifei lun}, dotyczyła Bodhidharmy i cesarza Liang Wudi (梁武帝 \nazwisko{Liáng Wǔdì}).
...
\if 0
Yampolsky
Nawet jeżeli istniał Bodhidharma, linia przekazu Chan\index{Chan} raczej nie istniała w nieprzerwanej formie
...
\subsection{Wiersze Shenxiu i Huinenga\index{Dajian Huineng}}
...
Opis konkursu poezji, zawarty w tekście \textit{Sutry platformy\index{Sutra platformy, 壇經}}, ma za zadanie udowodnić wyższość nauk Huinenga\index{Dajian Huineng} i jego spadkobierców nad naukami Shenxiu.
...
\section{Opowieści o uczniach Huinenga\index{Dajian Huineng}}
...
Wówczas Szósty Patriarcha spytał Zhichenga o szczegóły doktryny Shenxiu, a dokładniej, jakie były jego nauki na temat moralności (właściwego postępowania), medytacji\index{medytacja} i mądrości (戒定惠 \pinyin{jiè dìng huì}, dosł. `ślubowania, medytacja i mądrość').
...
\textit{Sutra platformy} pozostaje jednym z najbardziej popularnych i wpływowych tekstów buddyzmu Chan\index{Chan} do dnia dzisiejszego, a analizie zawartych w niej nauk i opowieści poświęcono wiele prac naukowych.

\section{Podział Chan\index{Chan} na Szkołę Północną i Południową}
...
W roku 720 Shenhui przebywał w miejscowości Nanyang nieopodal Luoyangu, gdzie nauczał medytacji\index{medytacja}.
...
Dumoulin 1963: 70
W czasie, kiedy Bodhidharma przyniósł Chan\index{Chan} do Chin, na północy Chin był Buddhabhadra, a na południu szkoła 三论
